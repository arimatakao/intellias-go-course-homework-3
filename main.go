...
func main() {
	...
	if apple*2+float64(pear*2) < float64(money) {
		fmt.Println("Чи можемо ми купити 2 груші та 2 яблука? Так можемо")
	} else {
		fmt.Println("Чи можемо ми купити 2 груші та 2 яблука? Ні, не можемо")
	}
}
